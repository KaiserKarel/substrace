...
use substrace_utils::consts::{constant_simple, Constant};
use substrace_utils::diagnostics::{span_lint, span_lint_and_help, span_lint_and_sugg, span_lint_and_then};
use substrace_utils::macros::root_macro_call_first_node;
use substrace_utils::source::snippet;
use substrace_utils::ty::match_type;
use substrace_utils::{
...
fn extract_substrace_version_value(cx: &LateContext<'_>, item: &'_ Item<'_>) -> Option<Symbol> {
    ...
    attrs.iter().find_map(|attr| {
        if_chain! {
            ...
            if tool_name.ident.name.as_str() == "substrace"
...
impl<'tcx> LateLintPass<'tcx> for CollapsibleCalls {
    fn check_expr(&mut self, cx: &LateContext<'tcx>, expr: &'tcx hir::Expr<'_>) {
        ...
        if_chain! {
            ...
            if is_expr_path_def_path(cx, func, &["substrace_utils", "diagnostics", "span_lint_and_then"]);
...
impl<'tcx> LateLintPass<'tcx> for MatchTypeOnDiagItem {
    fn check_expr(&mut self, cx: &LateContext<'tcx>, expr: &'tcx hir::Expr<'_>) {
        ...
        if_chain! {
            ...
            if is_expr_path_def_path(cx, fn_path, &["substrace_utils", "ty", "match_type"]);
            ...
            then {
                ...
                span_lint_and_sugg(
                    ...
                    expr.span,
                    "usage of `substrace_utils::ty::match_type()` on a type diagnostic item",
                    "try",
                    format!("substrace_utils::ty::is_type_diagnostic_item({}, {}, sym::{})", cx_snippet, ty_snippet, item_name),
