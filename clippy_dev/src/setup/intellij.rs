...
const CLIPPY_PROJECTS: &[ClippyProjectInfo] = &[
    ...
    ClippyProjectInfo::new("substrace_lints", "substrace_lints/Cargo.toml", "substrace_lints/src/lib.rs"),
    ClippyProjectInfo::new("substrace_utils", "substrace_utils/Cargo.toml", "substrace_utils/src/lib.rs"),
];
