...
fn dogfood_clippy() {
    ...
    // "" is the root package
    for package in &["", "clippy_dev", "substrace_lints", "substrace_utils", "rustc_tools_util"] {
...
fn run_metadata_collection_lint() {
    ...
    run_clippy_for_package("substrace_lints", &["-A", "unfulfilled_lint_expectations"]);
    ...
    filetime::set_file_mtime(
        PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("substrace_lints/src/lib.rs"),
