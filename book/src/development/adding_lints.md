...
This command will create a new file: `myclippy_lints/src/foo_functions.rs`, as well
as [register the lint](#lint-registration).

### Specific Type
Command: `cargo dev new_lint --name=foo_functions --type=functions --category=pedantic`

This command will create a new file: `myclippy_lints/src/{type}/foo_functions.rs`.
