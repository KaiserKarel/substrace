...
#[cfg(not(windows))]
const CLIPPY_DRIVER_PATH: &str = "target/debug/substrace-driver";
#[cfg(not(windows))]
const CARGO_CLIPPY_PATH: &str = "target/debug/cargo-substrace";

#[cfg(windows)]
const CLIPPY_DRIVER_PATH: &str = "target/debug/substrace-driver.exe";
#[cfg(windows)]
const CARGO_CLIPPY_PATH: &str = "target/debug/cargo-substrace.exe";
...
impl Crate {
    ...
    fn run_clippy_lints(
        ...
        if let Some(options) = &self.options {
            ...
            args.extend(&["-Wsubstrace::pedantic", "-Wsubstrace::cargo"])
        }
